...
2. Source: **Deploy from a branch** را انتخاب کنید
3. Branch: **gh-pages** را انتخاب کنید
4. Folder: **/ (root)** را انتخاب کنید
5. Save را بزنید
6. بعد از چند دقیقه، سایت شما در آدرس زیر لایو می‌شود:
   ```
   https://YOUR_USERNAME.github.io/hooshyar/
   ```

**نکته**: فایل `.nojekyll` اضافه شده تا GitHub از Jekyll استفاده نکند و فایل HTML به صورت مستقیم سرو شود.
